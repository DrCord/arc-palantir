<template>
  ...
  >
    ...
    <v-list-item v-if="contentType === 'ability-create'">
      <ability-create
        @ability-create-complete="closeContextBar"
      />
    </v-list-item>
    <v-list-item v-if="contentType === 'ability-delete'">
      <ability-delete
        @ability-delete-complete="closeContextBar"
      />
    </v-list-item>
    <v-list-item v-if="contentType === 'ability-edit'">
      <ability-edit
        @ability-edit-complete="closeContextBar"
      />
    </v-list-item>
    <v-list nav> </v-list>
  </v-navigation-drawer>
...
import Actions from '@/components/Abilities/ContextBar/Actions.vue'
import AbilityCreate from '@/components/Abilities/ContextBar/AbilityCreate.vue'
import AbilityDelete from '@/components/Abilities/ContextBar/AbilityDelete.vue'
import AbilityEdit from '@/components/Abilities/ContextBar/AbilityEdit.vue'
export default {
  name: 'AbilitiesContextBar',
  components: {
    Actions,
    AbilityCreate,
    AbilityDelete,
